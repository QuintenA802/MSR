...
#Task B - Summarize
    ...
    #   The differences can be seen in the Mean and Median and Standard Deviation. Please read the table below:
   ...
   #Mean
    ...
    #What are there differences?
    #   The differences averywhere when comparing males, females and combined. What stands out is that the range of income is shorter with females but have a higher median than men.
    ...
    #9
    #Only cell of the income data is missing. For this value I decided to make it have an income of "0" instead of "NA".
    ...
    #plot Venn diagram
    venn3(subsets=[male_no_consult, female_no_consult, consult_only, 0, male_consult, female_consult, 0],
